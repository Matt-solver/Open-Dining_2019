...
%>
	...
	%>
			...
			<div align="left"  class="tp timepicker0"  style="padding-left: 13%">
	 			<c:forEach var="j" begin="0" items="${today_TList }" end="15" varStatus="st">
					<span class="" style="text-align: center;">	
						<input type="button" id="r${j}" class="time time_admin time-sh"
							value="${j.calendarTime} " 
							onclick="deleteCalendar('${j.calendarTime}', 'today')">	
					</span>			
				</c:forEach>			
			</div>
			<div align="left"  class="tp timepicker1"  style="padding-left: 13%">
	 			<c:forEach var="j" begin="0" items="${manana_TList }" end="15" varStatus="st">
					<span class="" style="text-align: center;">	
						<input type="button" id="r${j}" class="time time_admin time-sh"
							value="${j.calendarTime} " 
							onclick="deleteCalendar('${j.calendarTime}', 'manana')">	
					</span>			
				</c:forEach>			
			</div>
			<div align="left"  class="tp timepicker2"  style="padding-left: 13%">
	 			<c:forEach var="j" begin="0" items="${third_TList }" end="15" varStatus="st">
					<span class="" style="text-align: center;">	
						<input type="button" id="r${j}" class="time time_admin time-sh"
							value="${j.calendarTime} " 
							onclick="deleteCalendar('${j.calendarTime}', 'third')">	
					</span>			
				</c:forEach>			
			</div>	
			<div align="left"  class="tp timepicker3"  style="padding-left: 13%">
	 			<c:forEach var="j" begin="0" items="${fourth_TList }" end="15" varStatus="st">
					<span class="" style="text-align: center;">	
						<input type="button" id="r${j}" class="time time_admin time-sh"
							value="${j.calendarTime} " 
							onclick="deleteCalendar('${j.calendarTime}', 'fourth')">	
					</span>			
				</c:forEach>			
			</div>	
			<div align="left"  class="tp timepicker4"  style="padding-left: 13%">
	 			<c:forEach var="j" begin="0" items="${fifth_TList }" end="15" varStatus="st">
					<span class="" style="text-align: center;">	
						<input type="button" id="r${j}" class="time time_admin time-sh"
							value="${j.calendarTime} " 
							onclick="deleteCalendar('${j.calendarTime}', 'fifth')">	
					</span>			
				</c:forEach>			
			</div>			
			<div align="left"  class="tp timepicker5"  style="padding-left: 13%">
	 			<c:forEach var="j" begin="0" items="${sixth_TList }" end="15" varStatus="st">
					<span class="" style="text-align: center;">	
						<input type="button" id="r${j}" class="time time_admin time-sh"
							value="${j.calendarTime} " 
							onclick="deleteCalendar('${j.calendarTime}', 'sixth')">	
					</span>			
				</c:forEach>			
			</div>		  
				...
				<div>
					<button type="button" id="" 
							...
							onclick="javascript:addCalendar($('.re_day').val())">
						Add Canlendar
					</button>
				</div>			
		...
		%>
			...
			<div align="left"  class="tp timepicker0"  style="padding-left: 13%">
	 			<c:forEach var="j" begin="0" items="${today_TList }" end="15" varStatus="st">
					<span class="" style="text-align: center;">	
						<input type="button" id="r${j}" class="time time_nomal time-sh"
							value="${j.calendarTime} " 
